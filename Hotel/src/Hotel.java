...
/**
 * A class that represents a one-room hotel and allows reservations to be made and cancelled for the month of March.
...
public class Hotel
{
    ...
    /**
     * Displays the full set of reservation information. Each day is marked with either the user with the reservation or Available.
     */
